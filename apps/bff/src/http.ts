...
export type BffAppEnvironment = {
  Variables: { requestId: string };
};

type BffContext = Context<BffAppEnvironment>;
type Schema<T> = {
...
export function installRequestLifecycle(app: Hono<BffAppEnvironment>): void {
...
export function requireBearerToken(token: string | undefined) {
  return async (c: BffContext, next: () => Promise<void>) => {
